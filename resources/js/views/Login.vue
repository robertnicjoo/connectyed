...
export default {
    ...
    methods: {
        ...
        addGlobalMetaTags() {
            ...
            description.setAttribute("content", "Login to Discover personalized matchmaking services with Comnectyed. Connect with expert matchmakers who understand your needs as a busy professional and start your journey to meaningful relationships today.");
            ...
            ogDescription.setAttribute("content", "Login to Discover personalized matchmaking services with Comnectyed. Connect with expert matchmakers who understand your needs as a busy professional and start your journey to meaningful relationships today.");
            ...
            ogUrl.setAttribute("content", "https://www.comnectyed.com/login");
