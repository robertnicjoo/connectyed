<template>
    <div>
        ...
        <p>Your profile is awaiting approval by the administrator to allow you to log in to the dashboard.</p>
    ...
    export default {
        ...
        methods: {
            addGlobalMetaTags() {
                ...
                ogUrl.setAttribute("content", "https://www.comnectyed.com/unauthorized");
